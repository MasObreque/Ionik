...
fbq('init', '1243580607965158');  <!-- Aquí va tu ID -->
fbq('track', 'PageView');
</script>
<noscript>
  <img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=1243580607965158&ev=PageView&noscript=1"/>
</noscript>
<!-- End Meta Pixel Code -->
...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-1TQV3P3CNY"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-1TQV3P3CNY');
</script>
